...
public class Tablero {
    ...
    public int nZom_enTablero(){
        ...
        for (int i = 0; i < x; i++) {
            for (int j = 0; j < y; j++) {
                if(this.getTablero(i,j).impresion.substring(0, 1).equals("Z")||this.getTablero(i,j).impresion.substring(0, 1).equals("C")||this.getTablero(i,j).impresion.substring(0, 1).equals("D")){
                    nZom+=1;
                }
            }
        }
